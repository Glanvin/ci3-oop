...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="editUserModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('AdminController/editUser'); ?>" method="post" class="needs-validation" novalidate>
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="tel" id="edit_contactnumber" name="contactnumber" class="form-control">
                        <div class="invalid-feedback">Please enter a valid contact number of 11 digits.</div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Admins cannot manually edit passwords. Click "Request Reset" to trigger a reset.</div>
                    </div>
                </div>
                
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <input type="submit" name="editModal" class="btn btn-primary" value="Save Changes">
                </div>
            </form>
        </div>
    </div>
